...
🎓 **3rd Year Computer Engineering student at PICT, Pune, India**  
🚀 System Design · Backend Development<br>
🌎 All IN on AI and Elegant System Designs

---

## 🚀My Projects

### 🔐 [Neokey : Zero-knowledge Stateless Password Platform](https://github.com/Rushikesh-Yeole/Neokey)  
✨ A Zero-knowledge stateless password platform that derives deterministic passwords with up to 256-bit entropy at runtime while eliminating 100% of PII and persistent secrets.<br>
⚙️ **Stack:** Node.js · React · MongoDB · Redis · Argon2id · BLAKE3 · GCP <br>
🔗 Neokey is live as a fully functional beta. 🚀 Scalable public launch coming soon!<br>
    *Try beta [here](https://neokey.onrender.com).*


### 🧠 [FARMS : Open Marketplace & Real-time Analytics Engine](https://github.com/Rushikesh-Yeole/FARMS)  
...
⚙️ **Stack:** FastAPI · MongoDB · Predictive Modeling <br>
...
⚙️ **Stack:** FastAPI ·  MongoDB · face_recognition · Google Cloud APIs <br>
...
![MySQL](https://img.shields.io/badge/-MySQL-4479A1?style=for-the-badge&logo=mysql&logoColor=white&label=)
...
---  
💡 Have a world-changing idea? Let’s architect it together.
